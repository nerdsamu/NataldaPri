...
function calcularDiasRestantes() {
   ...
   // Define a data do próximo Natal
   let dataAlvo = new Date(anoAtual, 11, 25); // Dezembro é o mês 11 (zero-based)

   // Se já passou o Natal deste ano, define para o próximo ano
   if (hoje > dataAlvo) {
